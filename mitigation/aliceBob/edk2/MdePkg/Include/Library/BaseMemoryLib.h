...
EFIAPI
CopyMem (
  OUT VOID       *DestinationBuffer _Itype(VOID* _Array) byte_count(Length),
  IN CONST VOID  *SourceBuffer _Itype(CONST VOID* _Array) byte_count(Length),
  IN UINTN       Length
  ) _Itype(VOID* _Array) byte_count(Length);
