...
_Checked INTN
StrCmp (
  CONST CHAR16              *FirstString : itype(_Array_ptr<CONST CHAR16>) byte_count(PcdMaximumUnicodeStringLength+1),
  CONST CHAR16              *SecondString : itype(_Array_ptr<CONST CHAR16>) byte_count(PcdMaximumUnicodeStringLength+1)
  )
{
  //
  // ASSERT both strings are less long than PcdMaximumUnicodeStringLength
