...
// GLOBALS
DEMO1_ACCESS_KEY * _Single aliceKey = NULL;
  ...
  )
{
  ...
  // Create Alice Key
  //
  aliceKey = (DEMO1_ACCESS_KEY * _Single)AllocatePool(sizeof(DEMO1_ACCESS_KEY));
...
EFIAPI
Demo1AliceProvideData(
  IN Demo1_Alice_PROTOCOL   * _Single This,
  IN EFI_HANDLE             Controller _Itype(VOID* _Single),
  IN OUT UINTN              * _Single Data
)
{
  EFI_STATUS Status = EFI_SUCCESS;
