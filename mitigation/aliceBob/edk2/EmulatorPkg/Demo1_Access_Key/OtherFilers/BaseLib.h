...
EFIAPI
StrCmp (
  IN      CONST CHAR16  *FirstString : itype(_Array_ptr<CONST CHAR16>) byte_count(PcdMaximumUnicodeStringLength +1),
  IN      CONST CHAR16  *SecondString : itype(_Array_ptr<CONST CHAR16>) byte_count(PcdMaximumUnicodeStringLength+1)
  );
