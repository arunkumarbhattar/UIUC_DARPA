...
**/
typedef _Ptr<EFI_STATUS (EFI_STATUS (_Ptr<CHAR16>, _Ptr<EFI_GUID>, UINT32, UINTN, void *))> EDKII_VAR_CHECK_REGISTER_SET_VARIABLE_CHECK_HANDLER)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<CHAR16>, _Ptr<EFI_GUID>, _Ptr<VAR_CHECK_VARIABLE_PROPERTY>)> EDKII_VAR_CHECK_VARIABLE_PROPERTY_SET)(
  IN CHAR16                         *Name,
  IN EFI_GUID                       *Guid,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<CHAR16>, _Ptr<EFI_GUID>, _Ptr<VAR_CHECK_VARIABLE_PROPERTY>)> EDKII_VAR_CHECK_VARIABLE_PROPERTY_GET)(
  IN CHAR16                         *Name,
  IN EFI_GUID                       *Guid,
