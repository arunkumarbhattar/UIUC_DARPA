...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_SMM_SYSTEM_TABLE2>, _Ptr<const EFI_GUID>, void *, UINTN)> EFI_SMM_INSTALL_CONFIGURATION_TABLE2)(
...
typedef _Ptr<EFI_STATUS (_Ptr<void (void *)>, UINTN, void *)> EFI_SMM_STARTUP_THIS_AP;
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, void *, EFI_HANDLE)> EFI_SMM_NOTIFY_FN;
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, void *, EFI_HANDLE)>, void **)> EFI_SMM_REGISTER_PROTOCOL_NOTIFY;
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, const void *, void *, _Ptr<UINTN>)> EFI_SMM_INTERRUPT_MANAGE;
typedef _Ptr<EFI_STATUS (EFI_HANDLE, const void *, void *, _Ptr<UINTN>)> EFI_SMM_HANDLER_ENTRY_POINT2;
typedef _Ptr<EFI_STATUS (_Ptr<EFI_STATUS (EFI_HANDLE, const void *, void *, UINTN *)>, _Ptr<const EFI_GUID>, EFI_HANDLE *)> EFI_SMM_INTERRUPT_REGISTER;
typedef _Ptr<EFI_STATUS (EFI_HANDLE)> EFI_SMM_INTERRUPT_UNREGISTER;
...
**/
typedef _Ptr<void (_Ptr<const EFI_SMM_ENTRY_CONTEXT>)> EFI_SMM_ENTRY_POINT)(
...
struct _EFI_SMM_SYSTEM_TABLE2 {
  ...
  ///
  _Ptr<EFI_CONFIGURATION_TABLE> SmmConfigurationTable;
