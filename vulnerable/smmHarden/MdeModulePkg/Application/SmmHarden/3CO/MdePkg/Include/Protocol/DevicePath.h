...
typedef struct {
  ...
  UINT8 Length _Checked[2]; ///< Specific Device Path data. Type and Sub-Type define
...
typedef struct {
  ...
  ///
  UINT8 WWN _Checked[8];
  ///
  /// 8 byte array containing Fibre Channel Logical Unit Number.
  ///
  UINT8 Lun _Checked[8];
...
typedef struct {
  ...
  ///
  _Ptr<EFI_IP_ADDRESS> DnsServerIp;
} DNS_DEVICE_PATH;
...
typedef struct {
  ...
  /// Starting Memory Address.
  ///
  UINT32 StartingAddr _Checked[2];
  ///
  /// Ending Memory Address.
  ///
  UINT32 EndingAddr _Checked[2];
  ///
