...
**/
typedef _Ptr<EFI_STATUS (EFI_ALLOCATE_TYPE, EFI_MEMORY_TYPE, UINTN, _Ptr<EFI_PHYSICAL_ADDRESS>)> EFI_ALLOCATE_PAGES)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINTN)> EFI_FREE_PAGES)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINTN>, _Ptr<EFI_MEMORY_DESCRIPTOR>, _Ptr<UINTN>, _Ptr<UINTN>, _Ptr<UINT32>)> EFI_GET_MEMORY_MAP)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_MEMORY_TYPE, UINTN, void **)> EFI_ALLOCATE_POOL)(
...
**/
typedef _Ptr<EFI_STATUS (void *)> EFI_FREE_POOL)(
  IN  VOID                         *Buffer
  );
...
**/
typedef _Ptr<EFI_STATUS (UINTN, UINTN, UINT32, _Ptr<EFI_MEMORY_DESCRIPTOR>)> EFI_SET_VIRTUAL_ADDRESS_MAP)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, EFI_HANDLE *, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, BOOLEAN)> EFI_CONNECT_CONTROLLER)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, EFI_HANDLE, EFI_HANDLE)> EFI_DISCONNECT_CONTROLLER)(
  IN  EFI_HANDLE                     ControllerHandle,
  IN  EFI_HANDLE                     DriverImageHandle  OPTIONAL,
...
**/
typedef _Ptr<EFI_STATUS (UINTN, void **)> EFI_CONVERT_POINTER)(
...
**/
typedef _Ptr<void (EFI_EVENT, void *)> EFI_EVENT_NOTIFY)(
  IN  EFI_EVENT                Event,
  IN  VOID                     *Context
  );
...
**/
typedef _Ptr<EFI_STATUS (UINT32, EFI_TPL, _Ptr<void (EFI_EVENT, void *)>, void *, EFI_EVENT *)> EFI_CREATE_EVENT)(
  IN  UINT32                       Type,
...
**/
typedef _Ptr<EFI_STATUS (UINT32, EFI_TPL, _Ptr<void (EFI_EVENT, void *)>, const void *, _Ptr<const EFI_GUID>, EFI_EVENT *)> EFI_CREATE_EVENT_EX)(
  IN       UINT32                 Type,
  IN       EFI_TPL                NotifyTpl,
...
**/
typedef _Ptr<EFI_STATUS (EFI_EVENT, EFI_TIMER_DELAY, UINT64)> EFI_SET_TIMER)(
  IN  EFI_EVENT                Event,
...
**/
typedef _Ptr<EFI_STATUS (EFI_EVENT)> EFI_SIGNAL_EVENT)(
  IN  EFI_EVENT                Event
  );
...
**/
typedef _Ptr<EFI_STATUS (UINTN, EFI_EVENT *, _Ptr<UINTN>)> EFI_WAIT_FOR_EVENT)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_EVENT)> EFI_CLOSE_EVENT)(
  IN EFI_EVENT                Event
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_EVENT)> EFI_CHECK_EVENT)(
  IN EFI_EVENT                Event
  );
...
**/
typedef _Ptr<EFI_TPL (EFI_TPL)> EFI_RAISE_TPL)(
  IN EFI_TPL      NewTpl
  );
...
**/
typedef _Ptr<void (EFI_TPL)> EFI_RESTORE_TPL)(
  IN EFI_TPL      OldTpl
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<CHAR16>, _Ptr<EFI_GUID>, _Ptr<UINT32>, _Ptr<UINTN>, void *)> EFI_GET_VARIABLE)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINTN>, _Ptr<CHAR16>, _Ptr<EFI_GUID>)> EFI_GET_NEXT_VARIABLE_NAME)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<CHAR16>, _Ptr<EFI_GUID>, UINT32, UINTN, void *)> EFI_SET_VARIABLE)(
  IN  CHAR16                       *VariableName,
  IN  EFI_GUID                     *VendorGuid,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIME>, _Ptr<EFI_TIME_CAPABILITIES>)> EFI_GET_TIME)(
  OUT  EFI_TIME                    *Time,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIME>)> EFI_SET_TIME)(
  IN  EFI_TIME                     *Time
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<BOOLEAN>, _Ptr<BOOLEAN>, _Ptr<EFI_TIME>)> EFI_GET_WAKEUP_TIME)(
  OUT BOOLEAN                     *Enabled,
  OUT BOOLEAN                     *Pending,
  OUT EFI_TIME                    *Time
  );
...
**/
typedef _Ptr<EFI_STATUS (BOOLEAN, _Ptr<EFI_TIME>)> EFI_SET_WAKEUP_TIME)(
  IN  BOOLEAN                      Enable,
...
**/
typedef _Ptr<EFI_STATUS (BOOLEAN, EFI_HANDLE, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, void *, UINTN, EFI_HANDLE *)> EFI_IMAGE_LOAD)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<UINTN>, _Ptr<_Ptr<CHAR16>>)> EFI_IMAGE_START)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, EFI_STATUS, UINTN, _Ptr<CHAR16>)> EFI_EXIT)(
  IN  EFI_HANDLE                   ImageHandle,
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE)> EFI_IMAGE_UNLOAD)(
  IN  EFI_HANDLE                   ImageHandle
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, UINTN)> EFI_EXIT_BOOT_SERVICES)(
  IN  EFI_HANDLE                   ImageHandle,
  IN  UINTN                        MapKey
  );
...
**/
typedef _Ptr<EFI_STATUS (UINTN)> EFI_STALL)(
...
**/
typedef _Ptr<EFI_STATUS (UINTN, UINT64, UINTN, _Ptr<CHAR16>)> EFI_SET_WATCHDOG_TIMER)(
  IN UINTN                    Timeout,
...
**/
typedef _Ptr<void (EFI_RESET_TYPE, EFI_STATUS, UINTN, void *)> EFI_RESET_SYSTEM)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINT64>)> EFI_GET_NEXT_MONOTONIC_COUNT)(
  OUT UINT64                  *Count
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINT32>)> EFI_GET_NEXT_HIGH_MONO_COUNT)(
...
**/
typedef _Ptr<EFI_STATUS (void *, UINTN, _Ptr<UINT32>)> EFI_CALCULATE_CRC32)(
  IN  VOID                              *Data,
  IN  UINTN                             DataSize,
  OUT UINT32                            *Crc32
  );
...
**/
typedef _Ptr<void (void *, void *, UINTN)> EFI_COPY_MEM)(
  IN VOID     *Destination,
  IN VOID     *Source,
  IN UINTN    Length
  );
...
**/
typedef _Ptr<void (void *, UINTN, UINT8)> EFI_SET_MEM)(
  IN VOID     *Buffer,
  IN UINTN    Size,
  IN UINT8    Value
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE *, _Ptr<EFI_GUID>, EFI_INTERFACE_TYPE, void *)> EFI_INSTALL_PROTOCOL_INTERFACE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE *)> EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACES)(
  IN OUT EFI_HANDLE           *Handle,
  ...
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, void *, void *)> EFI_REINSTALL_PROTOCOL_INTERFACE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, void *)> EFI_UNINSTALL_PROTOCOL_INTERFACE)(
  IN EFI_HANDLE               Handle,
  IN EFI_GUID                 *Protocol,
  IN VOID                     *Interface
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE)> EFI_UNINSTALL_MULTIPLE_PROTOCOL_INTERFACES)(
  IN EFI_HANDLE           Handle,
  ...
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, void **)> EFI_HANDLE_PROTOCOL)(
  IN  EFI_HANDLE               Handle,
  IN  EFI_GUID                 *Protocol,
  OUT VOID                     **Interface
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, void **, EFI_HANDLE, EFI_HANDLE, UINT32)> EFI_OPEN_PROTOCOL)(
  IN  EFI_HANDLE                Handle,
  IN  EFI_GUID                  *Protocol,
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, EFI_HANDLE, EFI_HANDLE)> EFI_CLOSE_PROTOCOL)(
  IN EFI_HANDLE               Handle,
  IN EFI_GUID                 *Protocol,
  IN EFI_HANDLE               AgentHandle,
  IN EFI_HANDLE               ControllerHandle
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_GUID>, _Ptr<_Ptr<EFI_OPEN_PROTOCOL_INFORMATION_ENTRY>>, _Ptr<UINTN>)> EFI_OPEN_PROTOCOL_INFORMATION)(
  IN  EFI_HANDLE                          Handle,
  IN  EFI_GUID                            *Protocol,
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<_Ptr<_Ptr<EFI_GUID>>>, _Ptr<UINTN>)> EFI_PROTOCOLS_PER_HANDLE)(
  IN  EFI_HANDLE      Handle,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GUID>, EFI_EVENT, void **)> EFI_REGISTER_PROTOCOL_NOTIFY)(
  IN  EFI_GUID                 *Protocol,
  IN  EFI_EVENT                Event,
...
**/
typedef _Ptr<EFI_STATUS (EFI_LOCATE_SEARCH_TYPE, _Ptr<EFI_GUID>, void *, _Ptr<UINTN>, EFI_HANDLE *)> EFI_LOCATE_HANDLE)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GUID>, _Ptr<_Ptr<EFI_DEVICE_PATH_PROTOCOL>>, EFI_HANDLE *)> EFI_LOCATE_DEVICE_PATH)(
  IN     EFI_GUID                         *Protocol,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GUID>, void *)> EFI_INSTALL_CONFIGURATION_TABLE)(
  IN EFI_GUID                 *Guid,
  IN VOID                     *Table
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_LOCATE_SEARCH_TYPE, _Ptr<EFI_GUID>, void *, _Ptr<UINTN>, EFI_HANDLE **)> EFI_LOCATE_HANDLE_BUFFER)(
  IN     EFI_LOCATE_SEARCH_TYPE       SearchType,
  IN     EFI_GUID                     *Protocol       OPTIONAL,
  IN     VOID                         *SearchKey      OPTIONAL,
  OUT    UINTN                        *NoHandles,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GUID>, void *, void **)> EFI_LOCATE_PROTOCOL)(
  IN  EFI_GUID  *Protocol,
...
typedef struct {
  ...
  ///
  _Ptr<VOID> CapsulePtr _Checked[1];
} EFI_CAPSULE_TABLE;
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<_Ptr<EFI_CAPSULE_HEADER>>, UINTN, EFI_PHYSICAL_ADDRESS)> EFI_UPDATE_CAPSULE)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<_Ptr<EFI_CAPSULE_HEADER>>, UINTN, _Ptr<UINT64>, _Ptr<EFI_RESET_TYPE>)> EFI_QUERY_CAPSULE_CAPABILITIES)(
  IN  EFI_CAPSULE_HEADER     **CapsuleHeaderArray,
  IN  UINTN                  CapsuleCount,
...
**/
typedef _Ptr<EFI_STATUS (UINT32, _Ptr<UINT64>, _Ptr<UINT64>, _Ptr<UINT64>)> EFI_QUERY_VARIABLE_INFO)(
  IN  UINT32            Attributes,
...
typedef struct {
  ...
  ///
  _Ptr<EFI_SIMPLE_TEXT_INPUT_PROTOCOL> ConIn;
  ///
  ...
  ///
  _Ptr<EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL> ConOut;
  ///
  ...
  ///
  _Ptr<EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL> StdErr;
  ///
  /// A pointer to the EFI Runtime Services Table.
  ///
  _Ptr<EFI_RUNTIME_SERVICES> RuntimeServices;
  ///
  /// A pointer to the EFI Boot Services Table.
  ///
  _Ptr<EFI_BOOT_SERVICES> BootServices;
  ///
  ...
  ///
  _Ptr<EFI_CONFIGURATION_TABLE> ConfigurationTable;
} EFI_SYSTEM_TABLE;
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_SYSTEM_TABLE>)> EFI_IMAGE_ENTRY_POINT)(
  IN  EFI_HANDLE                   ImageHandle,
