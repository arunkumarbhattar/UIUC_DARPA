...
typedef struct {
  UINT64    Signature;
  UINT8     Checksum;
  UINT8 OemId _Checked[6];
  UINT8     Revision;
  UINT32    RsdtAddress;
  UINT32    Length;
  UINT64    XsdtAddress;
  UINT8     ExtendedChecksum;
  UINT8 Reserved _Checked[3];
...
typedef struct {
  ...
  UINT8     Version;
  UINT8 Reserved0 _Checked[3];
  UINT32    OspmFlags;
  UINT8 Reserved1 _Checked[24];
...
typedef struct {
  ...
  UINT32    Flags;
  UINT8     LocalSapicEid;
  UINT8 ProximityDomain31To8 _Checked[3];
  UINT32    ClockDomain;
...
typedef struct {
  UINT8     Type;
  UINT8     Length;
  UINT8 Reserved1 _Checked[2];
  UINT32    ProximityDomain;
  UINT32    X2ApicId;
  UINT32    Flags;
  UINT32    ClockDomain;
  UINT8 Reserved2 _Checked[4];
...
typedef struct {
  EFI_ACPI_DESCRIPTION_HEADER    Header;
  UINT8 PlatformCommunicationChannelIdentifier _Checked[12];
...
typedef struct {
  ...
  UINT16    Status;
  UINT16    Version;
  UINT8 RASCapabilities _Checked[16];
  UINT8 SetRASCapabilities _Checked[16];
...
typedef struct {
  ...
  UINT64 RequestedAddressRange _Checked[2];
  UINT64 ActualAddressRange _Checked[2];
  UINT16    Flags;
...
///
typedef struct {
  UINT8 SectionType _Checked[16];
  UINT32    ErrorSeverity;
  UINT16    Revision;
  UINT8     ValidationBits;
  UINT8     Flags;
  UINT32    ErrorDataLength;
  UINT8 FruId _Checked[16];
  UINT8 FruText _Checked[20];
