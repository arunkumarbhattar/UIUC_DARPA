...
typedef PXE_UINT8 PXE_MAC_ADDR _Checked[32];
...
typedef struct s_pxe_sw_undi {
  ...
  PXE_UINT8 reserved2 _Checked[3];   ///< zero, not used.
  PXE_UINT8     BusCnt;         ///< number of bustypes supported.
  PXE_UINT32 BusType _Checked[1];     ///< list of supported bustypes.
} PXE_SW_UNDI;
...
typedef struct s_pxe_db_get_init_info {
  ...
  /// filled.
  ///
  PXE_UINT32 LinkSpeeds _Checked[4];
...
typedef struct s_pxe_cpb_receive_filters {
  ...
  ///
  PXE_MAC_ADDR MCastList _Checked[MAX_MCAST_ADDRESS_CNT];
...
typedef struct s_pxe_cpb_nvdata_sparse {
  ...
  ///
  struct Item_struct_1 Item _Checked[MAX_EEPROM_LEN];
...
typedef struct s_pxe_db_get_status {
  ...
  ///
  PXE_UINT64 TxBuffer _Checked[MAX_XMIT_BUFFERS];
} PXE_DB_GET_STATUS;
...
typedef struct s_pxe_cpb_fill_header_fragmented {
  ...
  ///
  struct FragDesc_struct_1 FragDesc _Checked[MAX_XMIT_FRAGMENTS];
...
typedef struct s_pxe_cpb_transmit_fragments {
  ...
  ///
  struct FragDesc_struct_2 FragDesc _Checked[MAX_XMIT_FRAGMENTS];
