...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_MM_SYSTEM_TABLE>, _Ptr<const EFI_GUID>, void *, UINTN)> EFI_MM_INSTALL_CONFIGURATION_TABLE)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<void (void *)>, UINTN, void *)> EFI_MM_STARTUP_THIS_AP)(
...
/**
  ...
  @return Status Code
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, void *, EFI_HANDLE)> EFI_MM_NOTIFY_FN)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, void *, EFI_HANDLE)>, void **)> EFI_MM_REGISTER_PROTOCOL_NOTIFY)(
  IN  CONST EFI_GUID     *Protocol,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_GUID>, const void *, void *, _Ptr<UINTN>)> EFI_MM_INTERRUPT_MANAGE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, const void *, void *, _Ptr<UINTN>)> EFI_MM_HANDLER_ENTRY_POINT)(
...
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<void> const, _Array_ptr<void>, _Ptr<UINTN>)> EFI_MM_HANDLER_ENTRY_POINT_C)(
  IN EFI_HANDLE  DispatchHandle,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_STATUS (EFI_HANDLE, const void *, void *, _Ptr<UINTN>)>, _Ptr<const EFI_GUID>, EFI_HANDLE *)> EFI_MM_INTERRUPT_REGISTER)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE)> EFI_MM_INTERRUPT_UNREGISTER)(
  IN EFI_HANDLE  DispatchHandle
  );
...
**/
typedef _Ptr<void (_Ptr<const EFI_MM_ENTRY_CONTEXT>)> EFI_MM_ENTRY_POINT)(
...
struct _EFI_MM_SYSTEM_TABLE {
  ...
  ///
  _Ptr<EFI_CONFIGURATION_TABLE> MmConfigurationTable;
